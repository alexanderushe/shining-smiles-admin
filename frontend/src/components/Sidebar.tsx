  ...
  return (
    <aside className="w-64 bg-zinc-900 h-screen fixed left-0 top-0 text-white flex flex-col border-r border-zinc-800">
      ...
      <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
        <Link href="/" className={`flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-all ${router.pathname === '/' ? 'bg-zinc-800 text-white' : 'text-zinc-400 hover:bg-zinc-800 hover:text-white'}`}>
